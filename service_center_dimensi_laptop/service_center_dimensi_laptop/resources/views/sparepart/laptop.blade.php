...
<div class="flex h-screen overflow-hidden bg-gray-100">
    {{-- Sidebar (Konsisten dengan Stok Laptop) --}}
    ...
    <span class="text-[11px] font-bold uppercase tracking-tight">Dashboard</span>
            ...
            <details class="group" open> {{-- Set open agar menu sparepart terlihat --}}
                ...
                <div class="ml-4 mt-1 space-y-1 border-l-2 border-blue-600 pl-2">
                    <a href="{{ route('sparepart.laptop') }}" class="flex items-center p-2 text-[9px] font-black text-blue-700 transition-colors">
                        • Sparepart Laptop
                    </a>
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-blue-700 to-blue-500 h-20 rounded-b-[2rem] mx-4 mt-2 shadow-lg p-5 flex justify-between items-center text-white">
            <h1 class="text-lg font-bold italic uppercase tracking-tighter">Input Stok Sparepart Laptop</h1>
        ...
        {{-- Area Form (Lebar max-w-5xl seperti Stok Laptop) --}}
            ...
            <div class="bg-white w-full max-w-5xl p-12 rounded-3xl shadow-xl border border-gray-100">
                ...
                <form action="#" method="POST" enctype="multipart/form-data" class="space-y-8">
                    ...
                    <div class="grid grid-cols-5 items-center gap-x-12 gap-y-8">
                        ...
                        {{-- 1. Jenis Sparepart (Ini Dropdown Pengganti Merk) --}}
                        ...
                        <div class="col-span-3">
                            <select name="jenis_sparepart" class="w-full bg-gray-50 border border-gray-200 rounded-lg px-4 py-3 text-sm font-medium text-gray-700 focus:border-blue-400 focus:ring-0 outline-none cursor-pointer transition-all">
                                ...
                                <option value="SSD">Storage (SSD/HDD)</option>
                        ...
                        {{-- 2. Nama / Seri Sparepart --}}
                        <label class="text-[12px] font-bold text-gray-600 uppercase col-span-2 text-right tracking-wider">Seri / Spesifikasi</label>
                        <div class="col-span-3">
                            <input type="text" name="nama_sparepart" class="w-full bg-gray-50 border border-gray-200 rounded-lg px-4 py-3 text-sm font-medium text-gray-700 placeholder:text-gray-400 focus:border-blue-400 focus:ring-0 outline-none transition-all" placeholder="Contoh: DDR4 8GB 3200Mhz atau SSD NVMe 512GB">
                        </div>
                        ...
                        <div class="col-span-3 flex items-center">
                            ...
                            <input type="text" id="placeholderFoto" class="flex-1 bg-gray-50 border border-gray-200 border-r-0 rounded-l-lg px-4 py-3 text-[12px] text-gray-500 outline-none" placeholder="Pilih Foto Produk..." readonly>
